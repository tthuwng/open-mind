...
class EmotionClassifier:
    ...
    def __init__(self, observed_emotions, alpha=0.09, batch_size=32, epsilon=1e-08, hidden_layer_sizes=[200 for i in range(5)], learning_rate='adaptive', learning_rate_init=0.0001, max_iter=5000):
        ...
        self.model = MLPClassifier(self.alpha, self.batch_size=32, self.epsilon, self.hidden_layer_sizes, self.learning_rate, self.learning_rate_init, self.max_iter)
        self.x_test = []
        self.y_test = []
        self.x_train = []
        self.y_train = []
